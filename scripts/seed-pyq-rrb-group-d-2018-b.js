/**
 * Seed: RRB Group D (RRC Group D, CEN-02/2018) PYQ — batch 2 (19, 26, 27, 28 September 2018, Shift-1)
 * Source: official answer-key papers (image-based), OCR + vision transcribed.
 * Answers from reliable green-tick decode. Garbled/figure-option/lost-stem Qs dropped.
 * Reuses the Exam + ExamPattern records created by seed-pyq-rrb-group-d-2018.js.
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2018-b.js
 */
...
import { PART as P19 } from './_p19.js';
import { PART as P26 } from './_p26.js';
import { PART as P27 } from './_p27.js';
import { PART as P28 } from './_p28.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 19 September 2018 Shift-1', parts: P19, dir: FIG_DIR },
    { title: 'RRB Group D - 26 September 2018 Shift-1', parts: P26, dir: FIG_DIR },
    { title: 'RRB Group D - 27 September 2018 Shift-1', parts: P27, dir: FIG_DIR },
    { title: 'RRB Group D - 28 September 2018 Shift-1', parts: P28, dir: FIG_DIR }
  ];
