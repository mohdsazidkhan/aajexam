/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2025 batch, 27 Nov 2025 CBT-1 (Shift-1/2/3)
 * Source: official iON CBT response-sheet papers WITH a real text layer (stems + options
 *   are extractable text, unlike the 2022 image-only sheets). Parsed by _parse_rrcgd25.py;
 *   answer = GREEN-TICK option (decoded deterministically from docx tick-bullets, authoritative —
 *   NOT candidate "Chosen Option"). Dropped: image-stem/image-option figure Qs, Telugu-garbled,
 *   fully-image Qs with no text marker.
 * Reuses the Exam + ExamPattern records created by seed-pyq-rrb-group-d-2018.js (same CBT pattern).
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2025-nov27.js
 */
...
import { PART as PS1 } from './_p2025s1_nov27.js';
import { PART as PS2 } from './_p2025s2_nov27.js';
import { PART as PS3 } from './_p2025s3_nov27.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 27 November 2025 Shift-1', shift: 'Shift-1', parts: PS1 },
    { title: 'RRB Group D - 27 November 2025 Shift-2', shift: 'Shift-2', parts: PS2 },
    { title: 'RRB Group D - 27 November 2025 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
