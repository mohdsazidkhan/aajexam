...
const BASE_IMG_DIR = "D:\\Sazid\\AajExam\\Exams PYQ's\\CIL\\2020";
const MAP_FILE = path.join(__dirname, 'cloudinary_map_cil_2020.json');

const jsons = [
    { file: '_parsed_cil2020_CIL-MT-Civil-2020-Paper.json', slug: 'cil-mt-2020-civil', extract_dir: '_extracted_CIL-MT-Civil-2020-Paper' },
    { file: '_parsed_cil2020_CIL-MT-Electrical-27-Feb-2020_Paper.json', slug: 'cil-mt-2020-electrical-feb27', extract_dir: '_extracted_CIL-MT-Electrical-27-Feb-2020_Paper' },
    { file: '_parsed_cil2020_CIL-MT-Electrical_-2020-Paper.json', slug: 'cil-mt-2020-electrical-other', extract_dir: '_extracted_CIL-MT-Electrical_-2020-Paper' },
    { file: '_parsed_cil2020_CIL-MT-Mechanical-27-Feb-2020_Paper.json', slug: 'cil-mt-2020-mechanical-feb27', extract_dir: '_extracted_CIL-MT-Mechanical-27-Feb-2020_Paper' },
    { file: '_parsed_cil2020_CIL-MT-System-CS-27-Feb-2020_Paper.json', slug: 'cil-mt-2020-system-cs-feb27', extract_dir: '_extracted_CIL-MT-System-CS-27-Feb-2020_Paper' }
];

async function uploadFile(filePath, filename) {
    try {
        const result = await cloudinary.uploader.upload(filePath, {
            folder: 'aajexam/exams/cil/2020',
...
async function run() {
    console.log('Starting Cloudinary Upload for CIL 2020...');
