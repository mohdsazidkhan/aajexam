...
const RAW = [
  ...
  { n: 92, s: "Computer Awareness / Fundamentals", q: "What action should be taken to add a new row or column in a spreadsheet?", o: ["Right-click on an existing row or column and select ‘Insert’ from the context menu.", "Use the ‘Find and Replace’ function to search for a specific cell, and then insert a", "Highlight a range of cells, right-click, and choose ‘Delete’ from the context menu to", "Select a row or column, press the ‘Ctrl+X’ keyboard shortcut to cut it, and then press"], a: 0, e: "", qimg: "" },
