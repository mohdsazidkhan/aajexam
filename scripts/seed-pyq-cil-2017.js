...
function cleanQuestions(questions) {
    return questions.map(q => {
        const prefixImg = img => img ? '/images/exams/cil/2017/' + img.split(',')[0].trim() : '';
...
async function run() {
    try {
        ...
        const tests = [
            {
                title: 'CIL MT 2017 - General Paper',
                slug: 'cil-mt-2017-general',
                file: '_parsed_cil2017_gen.json'
            },
            {
                title: 'CIL MT 2017 - Mechanical Paper',
                slug: 'cil-mt-2017-mechanical',
                file: '_parsed_cil2017_mech.json'
            },
            {
                title: 'CIL MT 2017 - Electrical Paper',
                slug: 'cil-mt-2017-electrical',
                file: '_parsed_cil2017_elec.json'
            }
        ];
