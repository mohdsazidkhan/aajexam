/**
 * Seed: RRB Group D (RRC Group D, CEN-02/2018) PYQ — batch 3 (4 Oct batch 2 (19, 26, 27, 28 September 2018, Shift-1) 6 Dec 2018, Shift-1)
 ...
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2018-c.js
 */
...
import { PART as POCT } from './_poct04.js';
import { PART as PDEC } from './_pdec06.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 4 October 2018 Shift-1', parts: POCT, dir: FIG_DIR },
    { title: 'RRB Group D - 6 December 2018 Shift-1', parts: PDEC, dir: FIG_DIR }
  ];
