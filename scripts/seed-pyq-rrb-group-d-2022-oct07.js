/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2022 batch, 7 Oct 2022 (Shift-1/2/3)
 ...
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2022-oct07.js
 */
...
import { PART as PS1 } from './_p2022s1_07.js';
import { PART as PS2 } from './_p2022s2_07.js';
import { PART as PS3 } from './_p2022s3_07.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 7 October 2022 Shift-1', shift: 'Shift-1', parts: PS1 },
    { title: 'RRB Group D - 7 October 2022 Shift-2', shift: 'Shift-2', parts: PS2 },
    { title: 'RRB Group D - 7 October 2022 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
