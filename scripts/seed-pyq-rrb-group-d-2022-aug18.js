/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2022 batch, 18 Aug 2022 (Shift-1/2/3)
 ...
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2022-aug18.js
 */
...
import { PART as PS1 } from './_p2022s1_18.js';
import { PART as PS2 } from './_p2022s2_18.js';
import { PART as PS3 } from './_p2022s3_18.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 18 August 2022 Shift-1', shift: 'Shift-1', parts: PS1 },
    { title: 'RRB Group D - 18 August 2022 Shift-2', shift: 'Shift-2', parts: PS2 },
    { title: 'RRB Group D - 18 August 2022 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
