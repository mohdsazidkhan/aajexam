...
const RAW = [
  ...
  { n: 97, s: "Computer Awareness / Fundamentals", q: "In MS-Word 365, what is the primary difference between the ‘Save’ and ‘Save As’ commands?", o: ["‘Save’ is used to save the document with a new filename or in a different location, while ‘Save As’ is used to save the document for the first time.", "‘Save’ is used to save the document in the cloud storage, while ‘Save As’ is used to save the document on the local computer.", "‘Save’ is used to save the document for the first time, while ‘Save As’ is used to save the document with a new filename or in a different location.", "Both ‘Save’ and ‘Save As’ perform the same function of saving the document; they are just two different names for the same command."], a: 2, e: "", qimg: "" },
