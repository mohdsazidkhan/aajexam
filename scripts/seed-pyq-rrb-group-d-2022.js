/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2022 batch
 *   (6 Oct 2022 Shift-1, Shift-2, Shift-3)
 * Source: official iON CBT response-sheet papers (image stems/options + green-tick answer),
 *   vision-transcribed @300 dpi. Answer = GREEN-TICK option (NOT candidate "Chosen Option").
 *   Figure/chart/table/cancelled Qs dropped.
 * Reuses the Exam + ExamPattern records created by seed-pyq-rrb-group-d-2018.js (same CBT pattern).
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2022.js
 */
...
import { PART as PS1 } from './_p2022s1.js';
import { PART as PS2 } from './_p2022s2.js';
import { PART as PS3 } from './_p2022s3.js';
...
const CLOUD_FOLDER = 'aajexam/pyq/rrb-group-d-2022';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 6 October 2022 Shift-1', shift: 'Shift-1', parts: PS1, dir: FIG_DIR },
    { title: 'RRB Group D - 6 October 2022 Shift-2', shift: 'Shift-2', parts: PS2, dir: FIG_DIR },
    { title: 'RRB Group D - 6 October 2022 Shift-3', shift: 'Shift-3', parts: PS3, dir: FIG_DIR }
  ];
