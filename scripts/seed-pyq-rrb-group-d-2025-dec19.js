/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2025 batch, 19 Dec 2025 CBT-1 (Shift-1/2/3)
 ...
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2025-dec19.js
 */
...
import { PART as PS1 } from './_p2025s1_dec19.js';
import { PART as PS2 } from './_p2025s2_dec19.js';
import { PART as PS3 } from './_p2025s3_dec19.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 19 December 2025 Shift-1', shift: 'Shift-1', parts: PS1 },
    { title: 'RRB Group D - 19 December 2025 Shift-2', shift: 'Shift-2', parts: PS2 },
    { title: 'RRB Group D - 19 December 2025 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
