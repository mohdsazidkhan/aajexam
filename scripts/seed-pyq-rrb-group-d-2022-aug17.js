/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2022 batch, 17 Aug 2022 (Shift-1/2/3)
 * Source: official iON CBT response-sheet papers (image stems/options + green-tick answer),
 *   vision-transcribed @200 dpi. Answer = GREEN-TICK option (decoded deterministically from the
 *   docx tick-bullets; NOT candidate "Chosen Option"). Figure/graph/table/garbled Qs dropped.
 *   Hindi-only Qs translated to clean English. All 5 tick-vs-key disagreements were resolved by
 *   inspecting the rendered page — decoded key correct in every case.
 * Reuses the Exam + ExamPattern records created by seed-pyq-rrb-group-d-2018.js (same CBT pattern).
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2022-aug17.js
 */
...
import { PART as PS1 } from './_p2022s1_17.js';
import { PART as PS2 } from './_p2022s2_17.js';
import { PART as PS3 } from './_p2022s3_17.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 17 August 2022 Shift-1', shift: 'Shift-1', parts: PS1 },
    { title: 'RRB Group D - 17 August 2022 Shift-2', shift: 'Shift-2', parts: PS2 },
    { title: 'RRB Group D - 17 August 2022 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
  ...
  for (const paper of papers) {
    ...
    const test = await PracticeTest.create({
      ...
      accessLevel: 'FREE', isPYQ: true, pyqYear: 2022, pyqShift: paper.shift,
