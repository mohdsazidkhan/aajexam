/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2022 batch, 24 Aug 2022 (Shift-3)
 ...
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2022-aug24.js
 */
...
import { PART as PS3 } from './_p2022s3_24.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 24 August 2022 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
