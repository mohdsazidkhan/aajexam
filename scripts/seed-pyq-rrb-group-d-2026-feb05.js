/**
 * Seed: RRB Group D (RRC Group D) PYQ — 2025 batch, 05 Feb 2026 CBT-1 (Shift-1/2/3)
 ...
 *
 * Run: node scripts/seed-pyq-rrb-group-d-2025-feb05.js
 */
...
import { PART as PS1 } from './_p2025s1_feb05.js';
import { PART as PS2 } from './_p2025s2_feb05.js';
import { PART as PS3 } from './_p2025s3_feb05.js';
...
async function seed() {
  ...
  const papers = [
    { title: 'RRB Group D - 05 February 2026 Shift-1', shift: 'Shift-1', parts: PS1 },
    { title: 'RRB Group D - 05 February 2026 Shift-2', shift: 'Shift-2', parts: PS2 },
    { title: 'RRB Group D - 05 February 2026 Shift-3', shift: 'Shift-3', parts: PS3 }
  ];
  ...
  for (const paper of papers) {
    ...
    const test = await PracticeTest.create({
      ...
      accessLevel: 'FREE', isPYQ: true, pyqYear: 2026, pyqShift: paper.shift,
