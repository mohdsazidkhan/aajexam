        ...
        <>
            ...
            <div className="py-4 lg:py-8 min-h-screen px-4 font-outfit relative overflow-hidden">
                ...
                <div className="container mx-auto px-0 lg:px-4 py-0 lg:py-6 relative">
                    ...
                    {/* Long-form intro */}
                    <section className="rounded-[3rem] shadow-2xl mb-10 border-2 border-b-[10px] border-slate-200 dark:border-slate-800 p-4 lg:p-8">
                    ...
                    {years.length === 0 ? (
                        <section className="rounded-[3rem] shadow-2xl mb-10 border-2 border-b-[10px] border-slate-200 dark:border-slate-800 text-center p-4 lg:p-8">
