                ...
                <div className="container mx-auto px-0 lg:px-4 py-0 lg:py-6 my-4">
                    <div className="bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl p-4 md:p-8 lg:p-12 border-2 border-b-[10px] border-slate-200 dark:border-slate-800 relative overflow-hidden">
                        ...
                        <div className="text-center mb-12">
                            <div className="w-20 h-20 bg-primary-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-aajexam-secondary">
                        ...
                        <div className="space-y-12 relative z-10">
                            ...
                            <section className="rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-800 p-4 lg:p-8">
                            ...
                            <section className="text-center border-t border-slate-100 dark:border-slate-800 p-4 lg:p-8">
