        ...
        <div className="max-w-md w-full bg-white dark:bg-slate-900 shadow-2xl rounded-[3rem] p-10 text-center border-2 border-slate-200 dark:border-slate-800 relative z-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-black py-4 px-8 rounded-2xl transition-all shadow-aajexam border-b-2 border-slate-200 dark:border-slate-700 active:translate-y-0.5 active:border-b-2 uppercase tracking-widest text-[10px]"
            >
              Go Back
            </button>
          </div>
