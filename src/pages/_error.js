            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {statusCode !== 404 && (
                <button
                  ...
                  className="flex-1 bg-primary-700 hover:bg-primary-600 text-white font-black py-4 px-8 rounded-2xl transition-all shadow-sm border-b-2 border-primary-700 active:translate-y-0.5 active:border-b-2 uppercase tracking-widest text-[10px]"
                >
                  Try Again
                </button>
              )}
