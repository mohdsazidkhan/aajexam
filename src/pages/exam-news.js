    ...
    <div className="space-y-6 lg:space-y-10 animate-fade-in bg-transparent font-outfit pb-10">
      ...
      <section className="relative rounded-[2.5rem] overflow-hidden shadow-sm border-b-2 border-black/20 dark:border-white/20 px-4 py-4 lg:p-8 mt-4 lg:mt-8">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          ...
          <h1 className="text-2xl lg:text-5xl font-black uppercase leading-tight text-black dark:text-white tracking-tighter">Exam News Hub</h1>
        ...
        <Megaphone className="absolute -bottom-10 -right-10 w-80 h-80 text-black/10 dark:text-white/10 rotate-12 pointer-events-none" />
      </section>
                ...
                <Card hoverable onClick={() => router.push(`/exam-news/${item.slug}`)}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`w-12 h-12 rounded-2xl ${cfg.color} flex items-center justify-center shrink-0 shadow-sm relative`}>
