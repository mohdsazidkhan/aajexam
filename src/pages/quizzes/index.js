                                        ...
                                        >
                                            ...
                                            <div className="p-3 lg:p-6">
                                                ...
                                                <div className="grid grid-cols-3 gap-4 mb-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                                                    ...
                                                    <div className="text-center">
                                                        <div className="text-2xl font-bold text-secondary-600 dark:text-secondary-400 flex items-center justify-center gap-1">
                                                ...
                                                {quiz.stats?.averageScore > 0 && (
                                                    <div className="flex items-center gap-2 mb-4">
                                                        ...
                                                        <span className="text-sm text-gray-600 dark:text-gray-400">
                                                            Avg Score: <span className="font-bold text-primary-600 dark:text-primary-400">{quiz.stats.averageScore}%</span>
                                                        </span>
                                                    </div>
                                                )}
                                                ...
                                                <div className="flex gap-3">
                                                    <Link href={`/quiz/${quiz._id}`} className="flex-1">
                                                        <button className="w-full px-4 py-2 border-2 border-primary-600 text-primary-600 dark:text-primary-400 dark:border-primary-400 rounded-lg font-semibold hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-300">
                                                            Details
                                                        </button>
                                                    </Link>
                                                    <button
                                                        onClick={() => handleStartQuiz(quiz._id)}
                                                        className="flex-1 px-4 py-2 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-secondary-700 transition-all duration-300 flex items-center justify-center gap-2"
                                                    >
