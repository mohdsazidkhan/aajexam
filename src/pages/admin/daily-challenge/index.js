        ...
        <div className="py-0 lg:py-6">
          <div className='flex justify-between items-center mb-6'>
            <div className='flex flex-col'>
              <h1 className="text-2xl font-black text-slate-900 dark:text-white flex items-center gap-2 mb-2"><Target className="w-6 h-6 text-primary-700" /> Daily Challenges</h1>
            ...
            <div className="p-2 space-y-3">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <button onClick={autoGenerateMonth} disabled={bulkGenerating} className="px-4 py-2 bg-primary-700 text-white rounded-lg lg:rounded-xl text-xs font-bold disabled:opacity-50">
