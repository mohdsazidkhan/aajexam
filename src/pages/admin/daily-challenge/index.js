          ...
          <div className='flex justify-between items-center mb-6'>
            ...
            <div className="p-2 space-y-3">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <button onClick={autoGenerateMonth} disabled={bulkGenerating} className="px-4 py-2 bg-primary-500 text-white rounded-lg lg:rounded-xl text-xs font-bold disabled:opacity-50">
              ...
              {bulkProgress && (
                <div className="mt-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg lg:rounded-xl border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="flex gap-4 text-[10px] font-bold">
                    ...
                    <span className="text-primary-500">Success: {bulkProgress.success}</span>
