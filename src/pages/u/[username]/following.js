              ...
              {following.map((user) => (
                ...
                >
                  {user.profilePicture ? (
                    ...
                    <div className="w-12 lg:w-16 h-12 lg:h-16 rounded-2xl bg-primary-700 flex items-center justify-center text-white text-md lg:text-xl font-black shadow-sm">
