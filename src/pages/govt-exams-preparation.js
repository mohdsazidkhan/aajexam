                ...
                <div className="py-0 lg:py-6">
                    ...
                    <div className="mt-32 bg-slate-950 dark:bg-slate-900 rounded-[3rem] p-4 lg:p-10 xl:p-20 text-white text-center border-2 border-slate-800 relative overflow-hidden shadow-2xl">
                        ...
                        <button
                            ...
                            className="bg-primary-500 hover:bg-primary-600 text-white px-12 py-5 rounded-[2rem] font-black uppercase tracking-widest text-sm shadow-aajexam-primary border-b-[8px] border-primary-700 active:translate-y-2 active:border-b-0 transition-all relative z-10"
                        >
                            Get Started Now
                        </button>
                    </div>
