          ...
          <div className="flex-1 max-w-xl bg-white/90 dark:bg-slate-900/90 rounded-[2rem] px-8 py-4 shadow-sm border-2 border-slate-200 dark:border-slate-800 backdrop-blur-md pointer-events-auto hidden md:block">
            <div className="flex flex-col gap-2">
              ...
              <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                <motion.div initial={{ width: 0 }} animate={{ width: `${progressPercent}%` }} className="h-full bg-primary-600 shadow-sm" />
              </div>
            </div>
          </div>
                ...
                return (
                  <div key={secName} className="space-y-2">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[10px] font-black text-primary-600 shrink-0">
                  ...
                  return (
                    <div key={secName} className="space-y-3">
                      <div className="flex items-center justify-between gap-2 px-1">
                        ...
                        <span className="text-[11px] font-black text-primary-600 shrink-0">
                          {answeredInSec}/{group.length}
                        </span>
                      </div>
