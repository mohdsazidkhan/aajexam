                ...
                <div className="py-0 lg:py-6 my-4">
                    <div className="bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl p-4 md:p-8 lg:p-12 border-2 border-slate-200 dark:border-slate-800 relative overflow-hidden">
                        ...
                        <div className="text-center mb-12">
                            <div className="w-20 h-20 bg-primary-700 rounded-full flex items-center justify-center mx-auto mb-6 shadow-aajexam-primary">
                        ...
                        <div className="space-y-12 relative z-10">
                            ...
                            <section className="rounded-[2rem] border-2 border-slate-100 dark:border-slate-800 px-0 py-4 lg:p-8">
                            ...
                            <div className="text-center pt-8 border-t border-slate-100 dark:border-slate-800">
                                ...
                                <button
                                    ...
                                    className="bg-primary-700 hover:bg-primary-600 text-white px-10 py-4 rounded-2xl font-black uppercase tracking-widest text-xs shadow-aajexam-primary border-b-2 border-primary-700 active:translate-y-1 active:border-b-0 transition-all"
                                >
                                    Back to Home
                                </button>
                            </div>
