            ...
            <div className="min-h-screen ">
                <div className="container mx-auto mt-0">
                    ...
                    <div className="text-center mb-8 lg:mb-12">
                        <div className="w-16 lg:w-24 h-16 lg:h-24 bg-primary-500 rounded-full flex items-center justify-center mx-auto mb-6">
                        ...
                        return (
                            <div key={catIndex} className="mb-8 lg:mb-12">
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="w-12 h-12 bg-primary-500 rounded-lg lg:rounded-xl flex items-center justify-center">
