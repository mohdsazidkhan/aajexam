...
const Cell = ({ value }) => {
  if (value === true) return <CircleCheck className="w-4 h-4 lg:w-5 lg:h-5 text-primary-600 mx-auto" />;
  ...
  return (
    <div className="min-h-screen animate-fade-in selection:bg-primary-600 selection:text-white">
      <div className="space-y-10 lg:space-y-16 mt-2 lg:mt-4">
        ...
        {/* --- Hero --- */}
        <section className="text-center space-y-3 lg:space-y-6 px-0 py-4 lg:py-8">
          <div className="w-14 h-14 lg:w-20 lg:h-20 bg-primary-600 text-white rounded-2xl lg:rounded-[2rem] flex items-center justify-center mx-auto shadow-sm rotate-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
          ...
          <Card className="p-4 lg:p-10 space-y-3 lg:space-y-6 border-2 border-primary-500/40 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between relative z-10">
              <div className="p-2.5 lg:p-4 bg-primary-500/10 text-primary-600 rounded-lg lg:rounded-xl xl:rounded-2xl">
