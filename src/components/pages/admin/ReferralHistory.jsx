    ...
    return (
      <AdminMobileAppWrapper title="Chronicle Stream">
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#060813] flex flex-col items-center justify-center p-8">
          ...
          <div className="mt-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.5em] animate-pulse">Reconstructing Transaction Chronicle...</div>
        </div>
        ...
        <div className={`transition-all duration-500 ${isOpen ? 'lg:pl-80' : 'lg:pl-24'} p-4 lg:p-10 pt-16 lg:pt-10`}>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6 mb-12">
                {[
                  ...
                  <motion.div
                    ...
                    className={`${stat.color} rounded-[2rem] p-6 lg:p-8 flex flex-col justify-between shadow-2xl relative overflow-hidden group`}
                  >
          ...
          <AnimatePresence mode="wait">
             {transactions.length === 0 ? (
               ...
               >
                 <History className="w-16 h-16 text-slate-300 dark:text-slate-600 mb-8" />
