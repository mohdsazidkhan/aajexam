              ...
              >
                <div className="p-3 lg:p-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl lg:rounded-[3rem] shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-8">
                      ...
                      <div className="lg:col-span-2 flex justify-end gap-4 pt-4 border-t border-white/10">
                        ...
                        <button
                          type="submit"
                          className="px-4 lg:px-10 py-4 bg-white text-primary-600 rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-3"
                        >
