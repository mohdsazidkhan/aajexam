        ...
        return (
            <AdminMobileAppWrapper title="Yield Analytics">
                <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#060813] flex flex-col items-center justify-center p-8">
                    ...
                    <div className="mt-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.5em] animate-pulse">Retrieving Yield Metadata...</div>
                </div>
                                        ...
                                        <table className="w-full">
                                            <thead>
                                                <tr className="bg-slate-50/50 dark:bg-slate-900 border-b border-slate-100 dark:border-white/10 text-left">
                                                    ...
                                                    <th className="px-8 py-8 text-[10px] font-black text-slate-400 uppercase tracking-widest">Identified_Recipient</th>
                                                    <th className="px-8 py-8 text-[10px] font-black text-slate-400 uppercase tracking-widest">Scholastic_Description</th>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                                        {transactions.map((tx, i) => (
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, y: 0 }}
                                                transition={{ delay: i * 0.05 }}
                                                className="group relative bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-[3rem] border-4 border-slate-100 dark:border-white/10 p-8 hover:border-emerald-500/30 transition-all shadow-xl flex flex-col items-center text-center overflow-hidden"
                                            >
                                                <div className="w-20 h-20 rounded-[1.5rem] bg-emerald-500/10 text-emerald-500 flex items-center justify-center mb-6 border-2 border-emerald-500/20 shadow-inner group-hover:scale-110 transition-transform">
                                    ...
                                    <div className="grid grid-cols-1 gap-6">
                                        {transactions.map((tx, i) => (
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, x: 0 }}
                                                transition={{ delay: i * 0.05 }}
                                                className="group relative bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-[3rem] border-4 border-slate-100 dark:border-white/10 p-6 lg:p-10 hover:border-emerald-500/30 transition-all shadow-xl flex flex-col lg:flex-row lg:items-center gap-8"
                                            >
                                                <div className="w-16 h-16 rounded-[1.5rem] bg-emerald-500/10 text-emerald-500 flex items-center justify-center shrink-0 border-2 border-emerald-500/20 shadow-lg group-hover:scale-110 transition-transform">
