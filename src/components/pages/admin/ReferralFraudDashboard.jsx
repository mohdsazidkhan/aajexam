      ...
      <div className="adminContent w-full mx-auto text-slate-900 dark:text-white font-outfit">
        <div className="transition-all duration-500">
          ...
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-5 mb-5">
              {stats.map((s, i) => (
                <motion.div key={s.label} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
                  className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-2xl lg:rounded-3xl border-2 border-slate-100 dark:border-white/10 p-4 lg:p-6 shadow-sm">
            ...
            {/* Filters */}
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-2xl lg:rounded-3xl border-2 border-slate-100 dark:border-white/10 p-4 lg:p-6 mb-4 shadow-sm flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                {rows.map((u) => {
                  ...
                  return (
                    <motion.div key={u._id} layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
                      className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-2xl lg:rounded-3xl border-2 border-slate-100 dark:border-white/10 shadow-sm overflow-hidden">
