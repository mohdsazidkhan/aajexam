               ...
               <div className="flex p-2 bg-white dark:bg-white/5 rounded-xl lg:rounded-[2.5rem] border-4 border-slate-100 dark:border-white/10 shadow-2xl">
                {['daily', 'weekly', 'monthly'].map((type) => (
                  <button
                    ...
                    className={`px-4 lg:px-8 py-3 rounded-lg lg:rounded-[2rem] text-[10px] font-black uppercase tracking-widest transition-all duration-500 ${activeTab === type
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 mb-4 lg:mb-12">
                {[
                  ...
                  <motion.div
                    ...
                    className={`${stat.color} rounded-xl lg:rounded-[2.5rem] p-3 lg:p-8 flex flex-col justify-between shadow-2xl relative overflow-hidden group min-h-[140px] text-white`}
                  >
                              ...
                              <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                                 {sortedUsers.map((user, i) => {
                                    ...
                                    return (
                                       ...
                                       >
                                          <td className="px-4 lg:px-8 py-3 lg:py-6 text-center tabular-nums opacity-30">#{serialNumber}</td>
                                          ...
                                          <td className="px-4 lg:px-8 py-3 lg:py-6 text-center text-sm italic tracking-tighter text-slate-900 dark:text-white tabular-nums">{user.monthlyProgress?.totalQuizAttempts || 0}</td>
                                          <td className="px-4 lg:px-8 py-3 lg:py-6 text-center">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-8">
                        {sortedUsers.map((user, i) => (
                           <motion.div
                              ...
                              animate={{ opacity: 1, scale: 1 }}
                              transition={{ delay: i * 0.05 }}
                              className="group bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-xl lg:rounded-[3rem] border-4 border-slate-100 dark:border-white/10 p-3 lg:p-10 hover:border-indigo-500/30 transition-all shadow-xl flex flex-col items-center text-center"
                           >
                              <div className="relative mb-6">
                                 <div className="w-20 h-20 bg-slate-900 dark:bg-white/10 text-white rounded-lg lg:rounded-[2rem] flex items-center justify-center border-4 border-slate-100 dark:border-white/10 shadow-lg group-hover:scale-110 group-hover:bg-primary-500 transition-all uppercase font-black text-2xl">
                                    {user.name?.[0]?.toUpperCase() || 'U'}
                                 </div>
                     ...
                     <div className="space-y-3 lg:space-y-6">
                        {sortedUsers.map((user, i) => (
                           <motion.div
                              ...
                              animate={{ opacity: 1, x: 0 }}
                              transition={{ delay: i * 0.05 }}
                              className="group bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-xl lg:rounded-[3rem] border-4 border-slate-100 dark:border-white/10 p-6 lg:p-10 hover:border-indigo-500/30 transition-all shadow-xl flex flex-col lg:flex-row items-center gap-10"
                           >
                              ...
                              <button
                                 onClick={() => handleViewUserDetails(user.originalUserId)}
                                 className="p-6 bg-white dark:bg-white/5 text-slate-400 border-4 border-slate-50 dark:border-white/10 rounded-lg lg:rounded-[2rem] hover:text-primary-500 hover:border-primary-500/30 hover:scale-105 active:scale-95 transition-all shadow-xl"
                              >
