      ...
      >
        ...
        <div className="adminContent p-2 lg:p-6 w-full">
           ...
           >
             <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
              ...
              <div className="flex flex-wrap items-center gap-4">
                    ...
                    className="px-8 py-4 bg-white dark:bg-white/5 text-slate-600 dark:text-white border-4 border-slate-100 dark:border-white/10 rounded-[2rem] text-[10px] font-black uppercase tracking-[0.2em] shadow-xl flex items-center gap-3"
                  >
            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-[3.5rem] border-4 border-slate-100 dark:border-white/10 p-6 lg:p-10 mb-12 shadow-2xl">
             <div className="flex flex-wrap items-center gap-8">
               <div className="flex items-center gap-4 px-6 py-4 bg-slate-100 dark:bg-white/10 rounded-2xl shadow-inner border-2 border-slate-200/50 dark:border-white/5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              {[
               ...
               <motion.div
                 ...
                 className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl p-10 rounded-[3rem] border-4 border-slate-100 dark:border-white/10 shadow-2xl group hover:border-indigo-600/30 transition-all relative overflow-hidden"
               >
                 <div className={`p-5 rounded-2xl bg-${stat.color}-500/10 text-${stat.color}-600 w-fit mb-8 group-hover:scale-110 group-hover:rotate-6 transition-transform shadow-inner`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
             ...
             <div className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl p-10 rounded-[3rem] border-4 border-slate-100 dark:border-white/10 shadow-2xl lg:col-span-1">
               ...
               {categoryLabels.length > 0 ? (
                 ...
                 <div className="h-72 flex flex-col items-center justify-center text-slate-300 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
             ...
             <div className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl rounded-[3.5rem] border-4 border-slate-100 dark:border-white/10 shadow-2xl overflow-hidden">
               <div className="p-8 lg:p-10 flex items-center justify-between border-b border-slate-100 dark:border-white/10">
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-slate-50/50 dark:bg-white/5 border-b border-slate-100 dark:border-white/10 text-left">
                      ...
                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Quiz Name</th>
                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Attempts</th>
                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Avg Score</th>
                    </tr>
                  </thead>
                  <tbody>
                    {data?.topQuizzes?.length > 0 ? (
                      data.topQuizzes.map((q, i) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-center text-sm font-black text-slate-900 dark:text-white tabular-nums">
                      ...
                      <tr>
                        <td
                          colSpan="4"
                          className="text-center py-0 lg:py-2 lg:py-4 xl:py-6 text-slate-700 dark:text-gray-400"
                        >
                          No quizzes found
                        </td>
                      </tr>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-slate-50/50 dark:bg-white/5 border-b border-slate-100 dark:border-white/10 text-left">
                      ...
                      <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Created</th>
                    </tr>
                  </thead>
                  <tbody>
                    {data.recentQuizzes?.length > 0 ? (
                      data.recentQuizzes.map((q, i) => (                        <tr
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-right text-xs font-black text-slate-400 tabular-nums">
