        ...
        <div className="adminContent p-4 lg:p-8 w-full text-slate-900 dark:text-white font-outfit mt-12 lg:mt-0">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 p-4 bg-white/50 dark:bg-slate-900/40 backdrop-blur-xl border-2 border-slate-100 dark:border-white/5 rounded-[2.5rem] shadow-sm">
              ...
              <div className="flex items-center gap-3 w-full lg:w-auto overflow-x-auto pb-1 lg:pb-0">
                ...
                <Button
                  ...
                  className="!px-6 !py-4 rounded-2xl !bg-emerald-600 hover:!bg-emerald-700 shadow-lg shadow-emerald-500/20 whitespace-nowrap"
                >
          ...
          <AnimatePresence>
            {showForm && (
              ...
              >
                <div className="p-8 lg:p-10 bg-gradient-to-br from-emerald-500 to-teal-700 rounded-[3rem] shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="lg:col-span-3 flex justify-end gap-4 pt-4 border-t border-white/10">
                        ...
                        <button
                          type="submit"
                          className="px-10 py-4 bg-white text-emerald-600 rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-3"
                        >
