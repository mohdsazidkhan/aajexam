...
import { ReelFeedSkeleton } from '../skeletons/PrivateSkeletons';
            ...
            <div className="absolute right-3 bottom-5 flex flex-col items-center gap-3 z-20" style={{ filter: 'drop-shadow(0 2px 8px rgba(0,0,0,0.5))' }}>
              ...
              <div className="relative">
                <Link href={`/u/${currentReel.createdBy?.username || 'aajexam'}`}>
                  <div className="w-9 h-9 rounded-full bg-primary-600 p-[2px]">
              ...
              <div className="px-4 pb-3 pt-12 pointer-events-auto">
                ...
                <div className="flex items-center gap-2 mb-2">
                  <Link href={`/u/${currentReel.createdBy?.username || 'aajexam'}`} className="shrink-0">
                    <div className="w-8 h-8 rounded-full bg-primary-600 p-[1.5px]">
            ...
            >
              ...
              <div className="px-5 pb-24 pt-2">
                ...
                <div className="space-y-2.5">
                  {[
                    { value: 'question', label: 'Question', icon: HelpCircle, gradient: 'bg-primary-600', desc: 'MCQ with explanation' },
                    { value: 'fact', label: 'Fact', icon: BookOpen, gradient: 'bg-primary-600', desc: 'Quick fact or one-liner' },
                    { value: 'tip', label: 'Tip / Trick', icon: Zap, gradient: 'bg-primary-600', desc: 'Shortcut or formula' },
                    { value: 'current_affairs', label: 'Current Affairs', icon: Newspaper, gradient: 'bg-primary-600', desc: 'Daily CA card' },
                    { value: 'poll', label: 'Poll', icon: BarChart3, gradient: 'bg-primary-600', desc: 'Community poll' },
                  ].map((type) => (
                    <Link
                      key={type.value}
