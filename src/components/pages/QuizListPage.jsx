        ...
        <div className="space-y-3">
          {filtered.map(quiz => (
            <div key={quiz._id} onClick={() => router.push(`/quiz/${quiz._id}`)}
              className="flex items-center gap-4 p-4 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 cursor-pointer hover:border-emerald-500 transition-all shadow-sm">
