...
export default function ReferralHistory() {
  ...
  const fetchReferralHistory = async (page = 1, limit = 20) => {
    try {
      setLoading(true);
      const params = {
        page,
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 md:p-6">
        <div className="container mx-auto px-0 lg:px-6 xl:px-8">
          ...
          {user && (() => {
            ...
            return (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-2 lg:p-6 mb-3 lg:mb-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/30 dark:to-primary-800/30 rounded-lg p-4 border border-primary-200 dark:border-primary-700">
                    <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">From Register</div>
