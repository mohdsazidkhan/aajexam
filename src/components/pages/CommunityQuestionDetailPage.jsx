          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            {question.exam?.name && (
              <>
                ...
                <span className="px-2 py-0.5 rounded-full bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-300 font-bold text-[10px] uppercase tracking-wider">
                  {question.exam.name}
                </span>
              </>
            )}
