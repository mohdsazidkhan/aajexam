  ...
  return (
    <>
      <div className="container mx-auto py-0 lg:py-4 px-0 lg:px-10 bg-gray-50 dark:bg-gray-900 min-h-screen">
        {/* Top Navigation Bar */}
        <div className="sticky top-0 z-10 flex items-center justify-between px-5 py-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm md:hidden">
          <button
            onClick={() => router.back()}
          ...
          <h1 className="text-md lg:text-xl font-bold text-gray-900 dark:text-white">Profile</h1>
          <div className="w-20">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-5">
              <div className="text-center md:text-left mb-4 md:mb-0">
                ...
                {profile.username && (
                  <p className="text-base lg:text-lg font-semibold text-primary-600 dark:text-primary-400 mt-1">
                    @{profile.username}
                  </p>
                )}
              </div>
