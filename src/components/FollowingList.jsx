                ...
                >
                  ...
                  <div className="relative shrink-0">
                    {user.profilePicture ? (
                      ...
                      <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-[2.5rem] bg-primary-500 flex items-center justify-center text-white text-4xl font-black shadow-aajexam-secondary border-4 border-white dark:border-slate-600 relative z-10 group-hover:scale-110 group-hover:rotate-3 transition-transform">
