                ...
                >
                  ...
                  <div className="relative shrink-0">
                    {user.profilePicture ? (
                      ...
                      <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-[2.5rem] bg-primary-500 flex items-center justify-center text-white text-4xl font-black shadow-duo-secondary border-4 border-white dark:border-slate-600 relative z-10 group-hover:scale-110 group-hover:rotate-3 transition-transform">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {user.monthlyProgress && (
                      <div className="inline-flex mt-4 px-4 py-2 bg-primary-500 text-white rounded-xl shadow-duo-secondary border-2 border-white dark:border-slate-700">
