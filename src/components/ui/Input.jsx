...
const Input = ({
  ...
  const variants = {
    white: 'bg-slate-50 dark:bg-black border-slate-300 dark:border-slate-700 shadow-sm focus-within:shadow-sm',
    glass: 'bg-slate-50/95 dark:bg-black/95 backdrop-blur-xl border-slate-300 dark:border-slate-700 shadow-sm focus-within:bg-white/70 dark:focus-within:bg-slate-800/70',
