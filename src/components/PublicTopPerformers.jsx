              ...
              <div key={performer?._id || `performer-${index}`} className={`bg-white dark:bg-gray-900 rounded-xl p-4 border-2 transition-all duration-200 hover:shadow-lg group ${index === 0
                ...
                <div className="text-center mb-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-2xl text-blue-600 dark:text-blue-400">{performer?.name?.charAt(0)?.toUpperCase() || '?'}</span>
                  </div>
          ...
          {topPerformers.map((performer, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 lg:w-10 lg:h-10 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full flex items-center justify-center">
                  <span className="text-blue-600 dark:text-blue-400 text-sm">{performer?.name?.charAt(0)?.toUpperCase() || '?'}</span>
                </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-blue-200 dark:border-blue-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">🏆 Rank</th>
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">👤 Name</th>
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">📈 Level</th>
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">📚 Total Quizzes</th>
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">⭐ High Score Quizzes</th>
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">🎯 Accuracy</th>
                <th className="py-3 px-3 text-left text-blue-800 dark:text-blue-200 text-sm md:text-base">✅ Total Correct</th>
              </tr>
            </thead>
            <tbody>
              {topPerformers.map((performer, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-3">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full flex items-center justify-center">
                        <span className="text-sm text-blue-600 dark:text-blue-400">{performer?.name?.charAt(0)?.toUpperCase() || '?'}</span>
                      </div>
                      <div>
