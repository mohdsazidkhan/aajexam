...
const PracticeTestsEducational = ({ levels }) => {
    return (
        <section className="practice-tests-educational font-outfit px-0 py-4 lg:py-8">
            <div className="">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-[3rem] p-4 md:p-8 lg:p-12 border-2 border-slate-100 dark:border-slate-700 shadow-sm relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 relative z-10">
                        {[
                            ...
                            <div key={idx} className="bg-white dark:bg-slate-900 p-4 lg:p-8 rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:-translate-y-2 group/tip active:translate-y-0">
                                <h3 className={`inline-flex px-5 py-2 rounded-lg lg:rounded-xl text-[10px] font-black uppercase tracking-widest text-white mb-6 shadow-sm-${tip.color} bg-${tip.color}-500 transform -rotate-2 group-hover/tip:rotate-0 transition-transform`}>
                                    {tip.title}
                                </h3>
