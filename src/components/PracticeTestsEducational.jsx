...
const PracticeTestsEducational = ({ levels }) => {
    return (
        <section className="practice-tests-educational font-outfit px-0 py-4 lg:p-8">
            <div className="">
                {/* Main Heading with Icon */}
                <div className="text-center mb-20 animate-bounce-in">
                    <div className="inline-block mb-6">
                        <div className="w-24 h-24 bg-primary-700 rounded-[2rem] flex items-center justify-center shadow-aajexam-primary border-2 border-white dark:border-slate-800 rotate-3">
                ...
                <div className="space-y-12 mb-20">
                    ...
                    <div className="group bg-white dark:bg-slate-800 rounded-[2.5rem] p-10 lg:p-14 shadow-2xl border-2 border-slate-100 dark:border-slate-700 transition-all hover:-translate-y-2 relative overflow-hidden">
                        ...
                        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 relative z-10">
                            <div className="bg-primary-700 p-8 rounded-[2rem] shadow-aajexam-primary border-2 border-white dark:border-slate-800 -rotate-3 group-hover:-rotate-6 transition-transform">
                    ...
                    <div className="group bg-white dark:bg-slate-800 rounded-[2.5rem] p-10 lg:p-14 shadow-2xl border-2 border-slate-100 dark:border-slate-700 transition-all hover:-translate-y-2 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-20 lg:w-32 h-20 lg:h-32 bg-primary-500/5 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none group-hover:bg-primary-500/10 transition-colors"></div>
                        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 relative z-10">
                            <div className="bg-primary-700 p-8 rounded-[2rem] shadow-aajexam-secondary border-2 border-white dark:border-slate-800 rotate-3 group-hover:rotate-6 transition-transform">
