...
const Sidebar = () => {
  ...
  const sidebarSections = [
    ...
    },
    {
      title: 'ANALYTICS',
      items: [
        { path: '/admin/analytics/dashboard', icon: BarChart3, label: 'Overview', key: 'analytics-dashboard' },
  ...
  return (
    <div className={`fixed left-0 top-0 bottom-0 z-[155] flex flex-col transition-all duration-700 ease-out bg-white dark:bg-slate-900 border-r-2 border-slate-100 dark:border-slate-800 overflow-hidden ${isOpen ? 'translate-x-0 w-60' : '-translate-x-full w-0 opacity-0'}`}>
      {/* Navigation */}
