      ...
      {showHeader && (
        <header className="fixed top-0 left-0 right-0 z-[110] lg:hidden h-16 lg:h-20 bg-white/90 dark:bg-[#0A0F1E]/80 backdrop-blur-2xl border-b border-slate-200 dark:border-white/5 shadow-xl px-4 flex items-center justify-between overflow-hidden">
          ...
          <div className="flex items-center gap-3 relative z-10 transition-transform active:scale-95">
            <Link href="/admin/dashboard" className="w-10 h-10 rounded-lg lg:rounded-xl bg-primary-500 p-0.5 shadow-aajexam-primary">
          ...
          <div className="font-outfit hidden lg:flex">
            ...
            <motion.button
              ...
              className={`w-10 h-10 flex items-center justify-center rounded-lg lg:rounded-xl border-b-2 transition-all ${isOpen ? 'bg-primary-600 border-primary-800' : 'bg-primary-500 border-primary-700'
