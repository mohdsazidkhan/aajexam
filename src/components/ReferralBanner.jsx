...
const ReferralBanner = ({ user }) => {
  ...
  const getNextMilestone = () => {
    return { target: 10, reward: `₹${config.SUBSCRIPTION_PLANS.PRO.price} PRO plan`, color: 'from-blue-400 to-red-500' };
  };
    ...
    <div className="bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 dark:from-yellow-900/20 dark:via-orange-900/20 dark:to-red-900/20 backdrop-blur-sm rounded-3xl shadow-2xl p-6 border border-yellow-200/50 dark:border-yellow-400/30 mb-6">
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 rounded-2xl p-4 mb-6 border border-white/50">
        <div className="text-center mb-4">
          <div className="text-3xl font-bold text-orange-700 dark:text-yellow-400 mb-1">
            {referralCount}
          </div>
        ...
        <div className="mb-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-orange-700 dark:text-yellow-400 text-sm font-bold">
      ...
      <div className="grid grid-cols-1 gap-3 mb-6">
        ...
        <div
          className={`bg-gradient-to-br ${referralCount >= 10
            ? 'from-blue-400 to-red-500 text-white'
