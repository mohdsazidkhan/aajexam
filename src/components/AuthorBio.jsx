    ...
    return (
        <div className="mt-12 p-4 md:p-8 lg:p-12 bg-white dark:bg-slate-800 rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-700 shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 relative z-10">
                <div className="w-20 h-20 rounded-2xl bg-primary-500 shrink-0 flex items-center justify-center text-white text-xl lg:text-3xl font-black shadow-aajexam-primary border-2 border-white dark:border-slate-700 rotate-3 group-hover:rotate-6 transition-transform">
                    S
                </div>
                ...
                <div className="flex-1 text-center lg:text-left">
                    ...
                    <Link
                        href="/about-founder"
                        className="inline-flex items-center gap-3 px-8 py-4 bg-white dark:bg-slate-900 text-primary-700 dark:text-primary-500 font-black uppercase tracking-widest text-[10px] rounded-2xl border-2 border-slate-100 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all active:translate-y-1 shadow-sm"
                    >
                        Meet the Founder
                    </Link>
                </div>
