...
const REEL_TYPES = [
  { value: 'question', label: 'Question', icon: HelpCircle, gradient: 'from-black dark:from-white to-primary-600', desc: 'MCQ with explanation' },
  { value: 'fact', label: 'Fact', icon: BookOpen, gradient: 'from-primary-500 to-black dark:to-white', desc: 'Quick fact or one-liner' },
