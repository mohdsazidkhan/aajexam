        ...
        <div className="container mx-auto px-4 pointer-events-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <Link href="/login">
                <Button variant="ghost" size="sm" className="hidden sm:flex px-6 py-2 sm:py-3.5 rounded-2xl font-black uppercase tracking-widest text-xs border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800">Login</Button>
              </Link>
              <Link href="/register">
                <Button variant="primary" size="sm" className="px-6 py-2 sm:py-3.5 rounded-2xl font-black uppercase tracking-widest text-xs">Join Now</Button>
              </Link>
            </div>
          </div>
        </div>
