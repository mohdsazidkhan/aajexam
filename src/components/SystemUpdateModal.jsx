...
const SystemUpdateModal = ({ isOpen, onClose }) => {
  ...
  const tabs = [
    { id: 'daily', label: 'Daily', color: 'bg-blue-600' },
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 lg:p-4">
      ...
      >
        <div className="bg-gradient-to-r from-yellow-600 to-red-600 text-white p-3 lg:p-6 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100">Live on Web & Mobile App</p>
              </div>
            </div>
            <button
              onClick={handleClose}
        ...
        <div className="p-3 lg:p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl p-4 lg:p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                <p className="font-bold text-yellow-300">1. Main Wallet (Withdrawable)</p>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-xl p-3 lg:p-4">
            <div className="flex flex-col items-start">
              <h3 className="text-md lg:text-lg font-semibold text-blue-800 dark:text-blue-200 mb-2">
              ...
              <p className="text-blue-700 dark:text-blue-300 text-sm lg:text-base">
                ...
                <span className="font-bold text-red-600 dark:text-red-400">Daily, Weekly, and Monthly</span>
          ...
          <div className={`bg-${rewardData[activeTab].color}-50 dark:bg-${rewardData[activeTab].color}-900/20 border border-${rewardData[activeTab].color}-200 dark:border-${rewardData[activeTab].color}-700 rounded-xl p-2 lg:p-4 transition-colors duration-300`}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
              {[
                { place: '1st', medal: '🥇', pct: '35%', color: 'text-orange-700' },
                { place: '2nd', medal: '🥈', pct: '25%', color: 'text-gray-400' },
                { place: '3rd', medal: '🥉', pct: '20%', color: 'text-orange-700' },
                { place: '4th', medal: '🏅', pct: '12%', color: 'text-blue-600' },
                { place: '5th', medal: '🏅', pct: '8%', color: 'text-blue-600' },
              ].filter((_, i) => {
                ...
                <div key={place} className="text-center bg-white dark:bg-gray-700 rounded-lg p-3 border border-transparent hover:border-blue-400/50 transition-all">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-pink-50 dark:from-orange-900/20 dark:to-pink-900/20 border border-orange-200 dark:border-orange-700 rounded-xl p-4">
            <h3 className="text-md lg:text-xl font-bold text-orange-800 dark:text-orange-200 mb-2 flex items-center">
              <FaGift className="text-2xl mr-2" />
              🎁 Referral Bonuses
            </h3>
            <p className="text-sm text-orange-700 dark:text-orange-300 mb-4 font-medium">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-xl p-4">
            ...
            <p className="text-yellow-700 dark:text-yellow-300 text-sm lg:text-base mb-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-b-2xl">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              onClick={handleClose}
              className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-200 hover:scale-105 shadow-lg"
            >
              Got It! Let's Start
            </button>
          </div>
