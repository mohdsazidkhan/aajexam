...
export default function GlobalErrorBanner() {
  ...
  return (
    <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-3rem)] max-w-xl animate-bounce-in pointer-events-auto">
      <div className="bg-white dark:bg-slate-900 border-2 border-black dark:border-white rounded-[2.5rem] p-6 shadow-2xl flex items-center justify-between gap-6 relative overflow-hidden group">
        ...
        <button
          onClick={clearError}
          className="p-4 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-2xl border-2 border-slate-100 dark:border-slate-700 transition-all shadow-aajexam active:translate-y-1 relative z-10 group/btn"
        >
