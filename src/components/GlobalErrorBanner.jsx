...
export default function GlobalErrorBanner() {
  ...
  return (
    <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-3rem)] max-w-xl animate-bounce-in pointer-events-auto">
      <div className="bg-white dark:bg-slate-900 border-4 border-b-[12px] border-black dark:border-white rounded-[2.5rem] p-6 shadow-2xl flex items-center justify-between gap-6 relative overflow-hidden group">
        ...
        <div className="flex items-center gap-6 relative z-10">
          <div className="w-14 h-14 bg-black dark:bg-white rounded-2xl flex items-center justify-center text-white dark:text-black shadow-aajexam-primary border-4 border-white dark:border-slate-800 rotate-3 group-hover:rotate-6 transition-transform">
        ...
        <button
          onClick={clearError}
          className="p-4 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-2xl border-2 border-b-4 border-slate-100 dark:border-slate-700 transition-all shadow-aajexam active:translate-y-1 relative z-10 group/btn"
        >
